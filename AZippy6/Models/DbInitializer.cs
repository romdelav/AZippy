        ...
        public static void Initialize(MembershipContext context)
        {
            ...
            context.FitnessClasses.Add(new FitnessClass()
            {
                ...
                fitnessclassDescription = "Interval training is a type of training that involves a series of low- to high-intensity "
                 + "workouts interspersed with rest or relief periods. The high-intensity periods are  typically at or close to " +
                 "anaerobic exercise, or an effort that feels hard or very hard, while the recovery periods involve activity of lower" +
                 " intensity. Varying the intensity of effort exercises the heart muscle, providing a cardiovascular workout, improving " +
                 "aerobic capacity.As an example, an interval workout might consist of alternating between 30 seconds of running at a " +
                 "sprint pace and 60 seconds of walking. " +
                 "Interval training can refer to the organization of any cardiovascular workout(e.g., cycling, running, rowing). It is " +
                 "prominent in training routines for many sports, but is particularly employed by runners."
            });
            ...
            context.ClassSessions.Add(new ClassSession()
            {
                classSessionId = 1,
                fitnessClassId = 101,
                classSessionStartTime = new DateTime(2017, 10, 30, 17, 30, 0),
                locationId = 1
            });
